# Shared settings between prod and dev
...
SPOTIFY_USER_CLIENT_ID = os.getenv('SPOTIFY_USER_CLIENT_ID')
SPOTIFY_USER_CLIENT_SECRET = os.getenv('SPOTIFY_USER_CLIENT_SECRET')
